    ...
    <>
      ...
      <div id="img-box">
        ...
        <div className="img-input-group">
          <input type="checkbox" className="avatar" name="avatar" id="avatar-orange" value="orange" 
                 onClick={event => {
        ...
        <div className="img-input-group">
          <input type="checkbox" className="avatar" name="avatar" id="avatar-blue" value="blue" 
                 onClick={event => {
                    singleSelection(event);
                    props.onClick(event.target.value);
                  }} />
        ...
        <div className="img-input-group">
          <input type="checkbox" className="avatar" name="avatar" id="avatar-green" value="green" 
                 onClick={event => {
                    singleSelection(event);
                    props.onClick(event.target.value);
                  }} />
        ...
        <div className="img-input-group">
          <input type="checkbox" className="avatar" name="avatar" id="avatar-yellow" value="yellow" 
                 onClick={event => {
                    singleSelection(event);
                    props.onClick(event.target.value);
                  }} />
        ...
        <div className="img-input-group">
          <input type="checkbox" className="avatar" name="avatar" id="avatar-red" value="red" 
                 onClick={event => {
                    singleSelection(event);
                    props.onClick(event.target.value);
                  }} />
        ...
        <div className="img-input-group">
          <input type="checkbox" className="avatar" name="avatar" id="avatar-dark-blue" value="dark-blue" 
                 onClick={event => {
                    singleSelection(event);
                    props.onClick(event.target.value);
                  }} />
        ...
        <div className="img-input-group">
          <input type="checkbox" className="avatar" name="avatar" id="avatar-light-blue" value="light-blue" 
                 onClick={event => {
                    singleSelection(event);
                    props.onClick(event.target.value);
                  }} />
        ...
        <div className="img-input-group">
          <input type="checkbox" className="avatar" name="avatar" id="avatar-beige" value="beige" 
                 onClick={event => {
                    singleSelection(event);
                    props.onClick(event.target.value);
                  }} />
        ...
        <div className="img-input-group">
          <input type="checkbox" className="avatar" name="avatar" id="avatar-purple" value="purple" 
                 onClick={event => {
                    singleSelection(event);
                    props.onClick(event.target.value);
                  }} />
